# 4.11 Test USB MINI HOST/DEVICE

This example demonstrates use of the USB MINI(J18) interface of the development board to simulate a specified file or device as a Gadget device. It provided as a storage device to the HOST device.
